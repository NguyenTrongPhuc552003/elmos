...
func showArchConfig(ctx *Context) error {
...
func setArchTarget(ctx *Context, cmd *cobra.Command, target string) error {
...
func saveArchConfig(ctx *Context, archName string) error {
...
func selectToolchain(ctx *Context, cmd *cobra.Command, toolchainTarget string) error {
